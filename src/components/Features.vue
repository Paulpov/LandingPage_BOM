<template>
  <section class="bg-bookmark-blue py-20 mt-20 pb-60 lg:mt-60">
    <!-- Heading-->
    <div id="servicos" class="sm:w-3/4 lg:w-5/12 mx-auto px-2">
    ...
    <div class="relative mt-20 lg:mt-24">
      ...
      >
        ...
        <div class="flex flex-1 flex-col items-center lg:items-start">
          ...
          >
            Na Popov Transportes, garantimos sua satisfação com um controle
            total da operação. Nossa tecnologia de rastreamento avançado
            proporciona visibilidade em tempo real, permitindo que você planeje
            e decida com confiança. Utilizamos sistemas modernos para otimizar
            cada etapa, assegurando entregas pontuais e eficiência.
          </p>
          <p
            class="text-bookmark-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full"
          >
            Com a Popov Transportes, você está no comando, e nossa dedicação é
            superar suas expectativas em cada remessa.
          </p>
        </div>
      </div>
      <!-- Rounded rectangle -->
      <div
        class="hidden lg:block overflow-hidden bg-bookmark-dark rounded-r-full absolute h-80 w-2/4 -bottom-24 -left-36"
      ></div>
    </div>
    ...
    <div  class="relative mt-20 lg:mt-52">
      ...
      >
        <!-- Feature #1-->
        <div id="endereco" class="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
          <iframe
        ...
        <div class="flex flex-1 flex-col items-center lg:items-start">
          ...
          <p
            class="text-bookmark-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full"
          >
            Vamos conversar sobre transporte, compartilhar histórias e tomar um
            café juntos.
          </p>
        </div>
      </div>
    ...
    <div class="relative mt-20 lg:mt-52">
      ...
      >
        ...
        <div class="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
          <div>
            <iframe
              class="lg:flex-row rounded-lg flex flex-1 justify-center z-10 mb-10 lg:mb-0"
        ...
        <!-- Content-->
        <div id="comprometimento" class="flex flex-1 flex-col items-center lg:items-start">
          <h1 class="text-3xl text-bookmark-white">Comprometimento</h1>
          <p
            class="text-bookmark-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full"
          >
            Na Popov Transportes, nossa força reside em parcerias sólidas.
            Valorizamos nossos fornecedores, mantemos uma frota confiável e
            investimos no crescimento de nossos motoristas.
          </p>
          <p
            class="text-bookmark-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full"
          >
            Essas conexões fundamentais impulsionam nosso compromisso com
            excelência no transporte. Juntos, construímos um futuro de sucesso
            em cada trajeto.
          </p>
